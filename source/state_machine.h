...
typedef struct
{
	...
	int rs485_cmd_recv_buffer_id;
	int rs485_cmd_send_buffer_id;

	device_bcu_state_t  bcu_info;
	unsigned char dev_type;
	int pcu_any_recept_state;
	...
	int bcu_recv_monitor_control_info_id;
	...
	unsigned char d2d_is_connecting_without_ts;
	unsigned char d2d_hangup_d2p_flag; 
	unsigned char opposite_live_ann_active;
	unsigned char opposite_d2p_connect_active;
