...
{
	last_control_flag = control_flag;control_flag = 1;
	...
	last_control_flag = control_flag;control_flag = 186;
	if(bcu_read_key_1_status() == 0)//pa 按下
	{
	    //diag_printf("[1116-PA-key] \n");
	...
	last_control_flag = control_flag;control_flag = 187;
	if(bcu_read_key_2_status() == 0)//pc 按下
	{
	    //diag_printf("[1116-PC-key] \n");
