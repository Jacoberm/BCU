...
int LookupSndCard(cyg_io_handle_t *param_audio_handle)
{
	...
	{
		diag_printf("LookupSndCard:  lookup error\n");
	}
	else
	{
		diag_printf("LookupSndCard:  card lookup ok\n");
	}
...
void AdjustVolumeByGPIO(unsigned char current_volume)
{//PTC1和PTC2
	diag_printf(("AdjustVolumeByGPIO:current_volume %s ",__FUNCTION__));
	switch(current_volume)
	{
	case 1:
		hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(C, 1, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(C, 1, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_clear( CYGHWR_HAL_KINETIS_PIN(C, 1, 1, KINETIS_PIN_PULLUP) );

		hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(C, 2, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(C, 2, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_clear( CYGHWR_HAL_KINETIS_PIN(C, 2, 1, KINETIS_PIN_PULLUP) );
		diag_printf("CASE 1\n");
		break;
	case 2:
		hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(C, 1, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(C, 1, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_set( CYGHWR_HAL_KINETIS_PIN(C, 1, 1, KINETIS_PIN_PULLUP) );
	...
	case 3:
		...
		hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(C, 2, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(C, 2, 1, KINETIS_PIN_PULLUP) );
		hal_gpio_pin_set( CYGHWR_HAL_KINETIS_PIN(C, 2, 1, KINETIS_PIN_PULLUP) );
		diag_printf("CASE 3\n");
