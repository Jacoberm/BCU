...
{///<BCU 获取线路区间站台信息
	...
	{
		//debug_print(("BcuUpdateLcdLineStationArray: %d,%d,%d,%d\n",
		//		pcurrent_station_row->current_index,
		//		pcurrent_station_row->line_no,
		//		pcurrent_station_row->current_row_info.station_no,
		//		pcurrent_station_row->current_row_info.fix_across_station));
		...
		{
			bcu_state.pp_station_info[pcurrent_station_row->line_no - 3][pcurrent_station_row->current_row_info.station_no].skip_flag = 2;
		}
		else
		{
			bcu_state.pp_station_info[pcurrent_station_row->line_no - 3][pcurrent_station_row->current_row_info.station_no].skip_flag = 0;
		}

		strcpy((char *)bcu_state.pp_station_info[pcurrent_station_row->line_no - 3][pcurrent_station_row->current_row_info.station_no].name,
...
//				pcurrent_station_row->current_row_info.spec_open_door;
	...
	//debug_print(("BcuUpdateLcdLineStationArray: exit\n"));
	return 0;
}
